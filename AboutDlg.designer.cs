...
namespace CmeFastHandlerSample
{
	partial class AboutDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.bOk.Name = "bOk";
			this.bOk.Size = new System.Drawing.Size(128, 27);
			...
			this.lVersion.Location = new System.Drawing.Point(270, 51);
			...
			this.label2.Text = "Handler verison: ";
			// 
			// label1
			// 
			...
			this.label1.Text = "CME FAST Handler SAMPLE";
			// 
			// pictureBox1
			// 
			...
			this.Text = "About CME FAST Handler SAMPLE";
